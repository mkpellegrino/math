...
release	: $(FILE_NAME).c Makefile
	$(value CC) $(OPT) $(FILE_NAME).c $(CPPFLAGS) $(CXXFLAGS) $(INCLUDE) $(LDFLAGS) -o $(BIN_DIR)$(FILE_NAME)
	@echo "Done."

debug	: $(FILE_NAME).c Makefile
	$(value CC) $(DEBUG) $(FILE_NAME).c $(CPPFLAGS) $(CXXFLAGS) $(INCLUDE) $(LDFLAGS) -o $(BIN_DIR)$(FILE_NAME)-debug
	@echo "Done."
